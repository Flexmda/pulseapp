...
class _AuthCreateWidgetState extends State<AuthCreateWidget> {
  ...
  void initState() {
    ...
    _model.vehiculoTextController ??= TextEditingController();
    _model.vehiculoFocusNode ??= FocusNode();
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 12.0, 12.0),
                              child: Text(
                                'Crea tu cuenta y accede a nuestro universo de opciones.',
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  'Este es un perfil de conductor/a?',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Readex Pro',
                            ...
                            if (valueOrDefault<bool>(
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 12.0, 16.0, 0.0),
                                child: TextFormField(
                                  controller: _model.vehiculoTextController,
                                  focusNode: _model.vehiculoFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .vehiculoTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                        ...
                        onPressed: () async {
                          ...
                          await UsersRecord.collection.doc(user.uid).update({
                            ...createUsersRecordData(
                              isDriver: _model.switchValue,
                              phoneNumber:
                                  _model.phoneNumberTextController.text,
                              vehiculo: _model.vehiculoTextController.text,
                              displayName:
